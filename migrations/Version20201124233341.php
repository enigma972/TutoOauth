 ...
 */
final class Version20201124233341 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        , github_id INTEGER DEFAULT NULL, password VARCHAR(255) DEFAULT NULL)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        , github_id INTEGER DEFAULT NULL, password VARCHAR(255) NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO user (id, email, roles, password, github_id) SELECT id, email, roles, password, github_id FROM __temp__user');
        $this->addSql('DROP TABLE __temp__user');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8D93D649E7927C74 ON user (email)');
    }
